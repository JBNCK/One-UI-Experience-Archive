...
Get the JBNCK One UI Experience on your Samsung Phone without root. Works best on Galaxy A-Series and Tab S phones/tablets running Android 11 or 12
## Features
...
## Installation \*\*\*\*
### Read this first if you are on Mac or Linux
Before running the script make sure you have made both the adb binary and the script executable. Adb will be blocked by MacOS by default. You can unblock it in the security tab in the settings app.
### Instructions
...
To start the installation, download the latest release (DO NOT CLONE THE REPO, IT DOES NOT INCLUDE THE ADB BINARY! USE A RELEASE! ANY XDA COMMENT THAT SAYS THAT THERE IS NO ADB AND NO APPS GET INSTALLED WILL BE IGNORED!) and unzip the file. On your phone, make sure you have USB debugging enabled. After enabling USB debugging connect your phone to your computer via a USB cable and execute the script (there are 3 files, choose the one that suits your operating system).
## Troubleshooting
### Bootloop
